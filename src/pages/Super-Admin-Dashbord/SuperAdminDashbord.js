            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0 font-size-18">Super Admin</h4>
              ...
              <div className="col-lg-12">
                <div className="row">
                      ...
                      <div className="card-body">
                        <Link to="/admin-menudashbord">
                          <div className="text-center">
                            ...
                            {/* <!-- <h2 className="mb-4 font-size-24 text-primary">Users</h2> --> */}
                      ...
                      <div className="card-body">
                        <Link to="/user-menu-deshbord">
                          <div className="text-center">
                            ...
                            {/* <!-- <h2 className="mb-4 font-size-24 text-primary">Admin</h2> --> */}
                          </div>
                        </Link>
                      </div>
                      {/* <!-- <div className="card-footer bg-transparent border-top">
                  ...
                  <div className="col-md-3">
                    <div className="card mini-stats-wid">
                      <div className="card-body">
                        <Link to="/company-admin-dashbord">
                          <div className="text-center">
                            <div className="d-inline-block mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                              <span className="avatar-title">
                      ...
                      {/* <!-- <div className="card-footer bg-transparent border-top">
                                        <div className=" d-flex font-size-20 justify-content-center">
                                            <a href="document-log.php" className="btn btn-primary waves-effect waves-light btn-sm">View List</a>
                                        </div>
                                    </div> --> */}
                    </div>
                  </div>
                  <div className="col-md-3">
                    <div className="card mini-stats-wid">
                      <div className="card-body">
                        <Link to="/analytic-dashbord">
                          <div className="text-center">
                            ...
                            <p className="text-muted fw-medium"></p>
                            {/* <!-- <h2 className="mb-4 font-size-24 text-primary">Analytics</h2> --> */}
                            <h2 className="mb-4 font-size-24 text-primary">
                      ...
                      {/* <!-- <div className="card-footer bg-transparent border-top">
                                        <div className=" d-flex font-size-20 justify-content-center">
                                            <a href="training-update-log.php" className="btn btn-primary waves-effect waves-light btn-sm">View List</a>
                                        </div>
                                    </div> --> */}
                    </div>
                  </div>
                  {/* <!-- <div className="col-md-4">
                                        <div className="card mini-stats-wid">
											...
											<div className="d-inline-block mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
													...
													<p className="text-muted fw-medium">Training<br/> completition Logs</p>
													<h2 className="mb-4 font-size-24 text-primary">1,235</h4>
											...
											<div className="card-footer bg-transparent border-top">
                                        <div className=" d-flex font-size-20 justify-content-center">
                                            <a href="training-completition-log.php" className="btn btn-primary waves-effect waves-light btn-sm">View List</a>
                                        </div>
                                    </div>
                                        </div> 
										</div> --> */}
